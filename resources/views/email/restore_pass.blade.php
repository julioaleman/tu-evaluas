...
Hola, da clic en el siguiente link para cambiar tu contraseña</h2>
<p><a href="{{ url('password/' . $pass_key) }}">Recuperar contraseña</a></p>
<p>Este link será válido durante 3 días.</p>
</ul>
