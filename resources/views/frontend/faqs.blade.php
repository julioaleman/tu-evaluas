...
<div class="container">
	<div class="row">
		...
		<div class="col-sm-8 col-sm-offset-2">
			...
			<h2>¿Cómo van a usar mis respuestas?</h2>
			...
			<h2>¿Cómo fueron obtenidos mis datos de contacto para invitarme a participar en una encuesta?</h2>
			...
			<h2>¿Cómo puedo participar en una encuesta?</h2>
			...
			<h2>Al responder los cuestionarios del portal Tú Evalúas ¿existe algún riesgo de perder el apoyo o subsidio con el que cuento?</h2>
			...
			<h2>¿Qué significa que mis respuestas a los cuestionarios serán utilizadas como datos abiertos?</h2>
			...
			<h2>¿Cómo se garantiza la veracidad de la información del portal Tú Evalúas?</h2>
